...
proto:
	@protoc --proto_path=pkg/grpc/protobuf-schemas/proto/ --go_out=$(GOPATH)/src --go-grpc_out=$(GOPATH)/src --go-vtproto_out=$(GOPATH)/src --plugin protoc-gen-go-vtproto="$(GOPATH)/bin/protoc-gen-go-vtproto" --go-vtproto_opt=features=marshal+unmarshal+size+flat_oneofs pkg/grpc/protobuf-schemas/proto/waves/*.proto
	...
	@protoc --proto_path=pkg/ride/meta/proto --go_out=$(GOPATH)/src --go-grpc_out=$(GOPATH)/src pkg/ride/meta/proto/*.proto
