...
type scriptStorageState interface {
	...
	scriptAstFromRecordBytes(script proto.Script) (*scripting.Tree, error)
	newestScriptAstByKey(key []byte, filter bool) (*scripting.Tree, error)
	scriptTreeByKey(key []byte, filter bool) (*scripting.Tree, error)
	...
	newestScriptByAsset(assetID proto.AssetID, filter bool) (*scripting.Tree, error)
	scriptByAsset(assetID proto.AssetID, filter bool) (*scripting.Tree, error)
	...
	newestScriptByAddr(addr proto.WavesAddress, filter bool) (*scripting.Tree, error)
	newestScriptPKByAddr(addr proto.WavesAddress, filter bool) (crypto.PublicKey, error)
	scriptByAddr(addr proto.WavesAddress, filter bool) (*scripting.Tree, error)
