...
func TestGenesisConfig(t *testing.T) {
	...
	err = HandleGenesisBlock(dataDir, stateParams, ss)
	if err != nil {
...
func TestValidationWithoutBlocks(t *testing.T) {
	...
	err = HandleGenesisBlock(dataDir, DefaultTestingStateParams(), settings.MainNetSettings)
...
func TestPreactivatedFeatures(t *testing.T) {
	...
	err = HandleGenesisBlock(dataDir, DefaultTestingStateParams(), sets)
	assert.NoError(t, err, "adding genesis block failed")
