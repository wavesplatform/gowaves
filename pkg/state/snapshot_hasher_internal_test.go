...
func TestTxSnapshotHasher(t *testing.T) {
	// Test data taken from TxStateSnapshotHashSpec in scala node code (except asset_volume_two's_complement)
	const (
	...
	testCases := []struct {
		...
		},
		{
			...
			pbInBase64:           "MigKIOfYm9p3M/NiYXCvwCU3ho5eVFpwE5iekWev4QXhZMvuEAEaAgDI",
