...
func createExchangeWithProofsWithMixedOrders(t *testing.T, txVersion byte, buyInfo, sellInfo orderBuildInfo) *proto.ExchangeWithProofs {
	...
	case orderV3:
		...
		bo = boV3
	case orderV4:
		boV4 := proto.NewUnsignedOrderV4(testGlobal.senderInfo.pk, testGlobal.matcherInfo.pk, *testGlobal.asset0.asset, *testGlobal.asset1.asset, proto.Buy, buyInfo.price, buyInfo.amount, 0, 0, 3, *testGlobal.asset2.asset, proto.OrderPriceModeDefault, proto.Attachment{})
		err := boV4.Sign(proto.TestNetScheme, testGlobal.senderInfo.sk)
		require.NoError(t, err, "boV4.Sign() failed")
		bo = boV4
	case ethereumOrderV4:
		eboV4 := proto.NewUnsignedEthereumOrderV4(&testGlobal.senderEthInfo.pk, testGlobal.matcherInfo.pk, *testGlobal.asset0.asset, *testGlobal.asset1.asset, proto.Buy, buyInfo.price, buyInfo.amount, 0, 0, 3, *testGlobal.asset2.asset, proto.OrderPriceModeDefault, proto.Attachment{})
	...
	case orderV3:
		...
		so = soV3
	case orderV4:
		soV4 := proto.NewUnsignedOrderV4(testGlobal.recipientInfo.pk, testGlobal.matcherInfo.pk, *testGlobal.asset0.asset, *testGlobal.asset1.asset, proto.Sell, sellInfo.price, sellInfo.amount, 0, 0, 3, *testGlobal.asset2.asset, proto.OrderPriceModeDefault, proto.Attachment{})
		err := soV4.Sign(proto.TestNetScheme, testGlobal.recipientInfo.sk)
		require.NoError(t, err, "soV4.Sign() failed")
		so = soV4
	case ethereumOrderV4:
		esoV4 := proto.NewUnsignedEthereumOrderV4(&testGlobal.recipientEthInfo.pk, testGlobal.matcherInfo.pk, *testGlobal.asset0.asset, *testGlobal.asset1.asset, proto.Sell, sellInfo.price, sellInfo.amount, 0, 0, 3, *testGlobal.asset2.asset, proto.OrderPriceModeDefault, proto.Attachment{})
