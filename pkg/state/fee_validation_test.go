...
func TestAssetScriptExtraFee(t *testing.T) {
	...
	err = checkMinFeeWaves(tx, params, false, 0) // it doesn't matter for these tests what version estimator is
	...
	err = checkMinFeeWaves(tx, params, false, 0)
...
func TestCheckMinFeeWaves(t *testing.T) {
	...
	tx1.Fee = FeeUnit * 34
	err = checkMinFeeWaves(tx1, params, false, 0)
	...
	tx2.Fee = FeeUnit * 2
	err = checkMinFeeWaves(tx2, params, false, 0)
...
func TestCheckMinFeeAsset(t *testing.T) {
	...
	tx.Fee = 1 * assetCost
	err = checkMinFeeAsset(tx, tx.FeeAsset.ID, params, false, 0)
...
func TestNFTMinFee(t *testing.T) {
	...
	require.Error(t, checkMinFeeWaves(issueA1, params, false, 0))
	require.Error(t, checkMinFeeWaves(issueA2, params, false, 0))
	require.NoError(t, checkMinFeeWaves(issueB1, params, false, 0))
	require.NoError(t, checkMinFeeWaves(issueB2, params, false, 0))

	require.Error(t, checkMinFeeWaves(nftA1, params, false, 0))
	require.Error(t, checkMinFeeWaves(nftA2, params, false, 0))
	...
	require.NoError(t, checkMinFeeWaves(nftA1, params, false, 0))
	require.NoError(t, checkMinFeeWaves(nftA2, params, false, 0))
}
...
func TestReissueFeeReduction(t *testing.T) {
	...
	require.Error(t, checkMinFeeWaves(reissueA1, params, false, 0))
	require.Error(t, checkMinFeeWaves(reissueA2, params, false, 0))
	require.NoError(t, checkMinFeeWaves(reissueB1, params, false, 0))
	require.NoError(t, checkMinFeeWaves(reissueB2, params, false, 0))

	storage.activateFeature(t, int16(settings.BlockV5))

	require.NoError(t, checkMinFeeWaves(reissueA1, params, false, 0))
	require.NoError(t, checkMinFeeWaves(reissueA2, params, false, 0))
	require.NoError(t, checkMinFeeWaves(reissueB1, params, false, 0))
	require.NoError(t, checkMinFeeWaves(reissueB2, params, false, 0))
}
...
func TestSponsorshipFeeReduction(t *testing.T) {
	...
	require.Error(t, checkMinFeeWaves(sponsorshipA, params, false, 0))
	require.NoError(t, checkMinFeeWaves(sponsorshipB, params, false, 0))

	storage.activateFeature(t, int16(settings.BlockV5))

	require.NoError(t, checkMinFeeWaves(sponsorshipA, params, false, 0))
	require.NoError(t, checkMinFeeWaves(sponsorshipB, params, false, 0))
}
