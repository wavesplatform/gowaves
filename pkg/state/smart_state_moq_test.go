...
//
//     }
type AnotherMockSmartState struct {
...
func (mock *AnotherMockSmartState) AssetInfoByID(id proto.AssetID, filter bool) (*proto.AssetInfo, error) {
	if mock.AssetInfoByIDFunc == nil {
		panic("AnotherMockSmartState.AssetInfoByIDFunc: method is nil but SmartState.AssetInfoByID was just called")
	}
	callInfo := struct {
		ID     proto.AssetID
		Filter bool
...
func (mock *AnotherMockSmartState) AssetInfoByIDCalls() []struct {
	ID     proto.AssetID
	Filter bool
} {
	var calls []struct {
...
func (mock *AnotherMockSmartState) GetByteTree(recipient proto.Recipient) (proto.Script, error) {
	if mock.GetByteTreeFunc == nil {
		panic("AnotherMockSmartState.GetByteTreeFunc: method is nil but SmartState.GetByteTree was just called")
	}
	callInfo := struct {
		Recipient proto.Recipient
	}{
...
func (mock *AnotherMockSmartState) GetByteTreeCalls() []struct {
	Recipient proto.Recipient
} {
	var calls []struct {
		Recipient proto.Recipient
...
func (mock *AnotherMockSmartState) NewestAccountBalance(account proto.Recipient, assetID []byte) (uint64, error) {
	if mock.NewestAccountBalanceFunc == nil {
		panic("AnotherMockSmartState.NewestAccountBalanceFunc: method is nil but SmartState.NewestAccountBalance was just called")
	}
	callInfo := struct {
		Account proto.Recipient
		AssetID []byte
...
func (mock *AnotherMockSmartState) NewestAccountBalanceCalls() []struct {
	Account proto.Recipient
	AssetID []byte
} {
	var calls []struct {
...
func (mock *AnotherMockSmartState) NewestScriptByAsset(asset proto.OptionalAsset) (proto.Script, error) {
...
func (mock *AnotherMockSmartState) NewestTransactionByID(in1 []byte) (proto.Transaction, error) {
...
func (mock *AnotherMockSmartState) NewestTransactionHeightByID(in1 []byte) (uint64, error) {
