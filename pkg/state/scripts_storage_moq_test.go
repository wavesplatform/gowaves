...
type mockScriptStorageState struct {
	...
	newestScriptAstByKeyFunc func(key []byte, filter bool) (*scripting.Tree, error)
	...
	newestScriptByAssetFunc func(assetID proto.AssetID, filter bool) (*scripting.Tree, error)
	...
	scriptAstFromRecordBytesFunc func(script proto.Script) (*scripting.Tree, error)

	// scriptByAddrFunc mocks the scriptByAddr method.
	scriptByAddrFunc func(addr proto.WavesAddress, filter bool) (*scripting.Tree, error)

	// scriptByAssetFunc mocks the scriptByAsset method.
	scriptByAssetFunc func(assetID proto.AssetID, filter bool) (*scripting.Tree, error)
	...
	scriptTreeByKeyFunc func(key []byte, filter bool) (*scripting.Tree, error)
...
func (mock *mockScriptStorageState) newestScriptAstByKey(key []byte, filter bool) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) newestScriptByAddr(addr proto.WavesAddress, filter bool) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) newestScriptByAsset(assetID proto.AssetID, filter bool) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) scriptAstFromRecordBytes(script proto.Script) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) scriptByAddr(addr proto.WavesAddress, filter bool) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) scriptByAsset(assetID proto.AssetID, filter bool) (*scripting.Tree, error) {
...
func (mock *mockScriptStorageState) scriptTreeByKey(key []byte, filter bool) (*scripting.Tree, error) {
