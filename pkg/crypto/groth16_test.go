...
func TestGroth16VerifyBN254RegressionInvalidCompressedCoordinate(t *testing.T) {
	keyHex := ""
	proofHex := ""
	inputsHex := ""

	key, err := hex.DecodeString(keyHex)
	require.NoError(t, err)
	proof, err := hex.DecodeString(proofHex)
	require.NoError(t, err)
	inputs, err := hex.DecodeString(inputsHex)
	require.NoError(t, err)

	result, err := Groth16Verify(key, proof, inputs, ecc.BN254)
	require.Error(t, err)
