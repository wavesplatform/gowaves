...
const _names_V4 = "!!=-@extrNative(1040)@extrNative(1041)@extrNative(1042)@extrNative(1043)@extrNative(1050)@extrNative(1051)@extrNative(1052)@extrNative(1053)@extrNative(1062)@extrUser(addressFromString)@extrUser(getBinary)@extrUser(getBoolean)@extrUser(getInteger)@extrUser(getString)"

var _index_V4 = [...]int{0, 1, 3, 4, 5, 6, 9, 13, 17, 21, 25, 29, 33, 36, 39, 42, 45, 49, 53, 57, 61, 64, 68, 72, 76, 80, 83, 87, 91, 95, 98, 102, 105, 109, 112, 116, 120, 124, 128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200, 204, 208, 212, 216, 220, 224, 228, 232, 236, 240, 244, 248, 252, 256, 260, 264, 265, 268, 271, 274, 277, 281, 285, 289, 293, 297, 301, 305, 309, 313, 317, 321, 325, 329, 333, 337, 341, 345, 349, 353, 357, 361, 365, 369, 373, 377, 381, 385, 389, 393, 397, 401, 405, 409, 413, 417, 421, 425, 429, 433, 437, 441, 445, 449, 453, 457, 461, 465, 469, 473, 477, 480, 483, 486, 489, 492, 495, 498, 501, 504, 507, 510, 513, 516, 519, 522, 525, 528, 531, 534, 537, 540, 543, 546, 549, 552, 555, 558, 561, 564, 581, 598, 615, 632, 649, 666, 683, 700, 717, 745, 765, 786, 807, 827, 834, 839, 848, 859, 871, 875, 878, 885, 900, 911, 915, 920, 928, 936, 942, 954, 957, 962, 969, 983, 987, 991, 997, 1003, 1010, 1017, 1024, 1031, 1037, 1043, 1053, 1064, 1068, 1070, 1090, 1107, 1115, 1130, 1139, 1153, 1160, 1169, 1179, 1189, 1198, 1207, 1220, 1229, 1243, 1248, 1253, 1264, 1283}
