...
func (m *InvokeScriptResult_Call_Argument_CaseObj) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CaseObj)))
	i--
	dAtA[i] = 0x2a
	return len(dAtA) - i, nil
}
...
func (m *InvokeScriptResult_Call) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.ArgsBytes) > 0 {
		for iNdEx := len(m.ArgsBytes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ArgsBytes[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *InvokeScriptResult_Invocation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.DApp) > 0 {
		i -= len(m.DApp)
		copy(dAtA[i:], m.DApp)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DApp)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
