...
func (m *SignedTransaction_EthereumTransaction) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EthereumTransaction)))
	i--
	dAtA[i] = 0x1a
	return len(dAtA) - i, nil
}
...
func (m *Transaction) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Data.(*Transaction_CommitToGeneration); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *Transaction_CommitToGeneration) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CommitToGeneration != nil {
		size, err := m.CommitToGeneration.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *TransferTransactionData) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.Attachment) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Attachment)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Amount != nil {
...
func (m *DataEntry) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Value.(*DataEntry_StringValue); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Value.(*DataEntry_BinaryValue); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Value.(*DataEntry_BoolValue); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Value.(*DataEntry_IntValue); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *ExchangeTransactionData) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.SellMatcherFee != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.SellMatcherFee))
		i--
		dAtA[i] = 0x20
	}
	if m.BuyMatcherFee != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.BuyMatcherFee))
		i--
		dAtA[i] = 0x18
	}
	if m.Price != 0 {
...
func (m *InvokeScriptTransactionData) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.FunctionCall) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FunctionCall)))
		i--
		dAtA[i] = 0x12
	}
	if m.DApp != nil {
...
func (m *CommitToGenerationTransactionData) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.GenerationPeriodStart != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.GenerationPeriodStart))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ExchangeTransactionData) SizeVT() (n int) {
	...
	if m.BuyMatcherFee != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.BuyMatcherFee))
	}
	if m.SellMatcherFee != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.SellMatcherFee))
	}
	if len(m.Orders) > 0 {
...
func (m *Transaction) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 120:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitToGeneration", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Data.(*Transaction_CommitToGeneration); ok {
				if err := oneof.CommitToGeneration.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &CommitToGenerationTransactionData{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Data = &Transaction_CommitToGeneration{CommitToGeneration: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *DataEntry) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.Value = &DataEntry_IntValue{IntValue: v}
		case 11:
			if wireType != 0 {
			...
			b := bool(v != 0)
			m.Value = &DataEntry_BoolValue{BoolValue: b}
		case 12:
			if wireType != 2 {
			...
			v := make([]byte, postIndex-iNdEx)
			copy(v, dAtA[iNdEx:postIndex])
			m.Value = &DataEntry_BinaryValue{BinaryValue: v}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
			...
			m.Value = &DataEntry_StringValue{StringValue: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *CommitToGenerationTransactionData) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommitToGenerationTransactionData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommitToGenerationTransactionData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GenerationPeriodStart", wireType)
			}
			m.GenerationPeriodStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return protohelpers.ErrIntOverflow
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GenerationPeriodStart |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
