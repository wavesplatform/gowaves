...
func (m *Amount) MarshalVTFlat() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Amount) MarshalToVTFlat(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTFlat(dAtA[:size])
}

func (m *Amount) MarshalToSizedBufferVTFlat(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
