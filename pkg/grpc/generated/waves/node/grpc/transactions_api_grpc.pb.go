...
type TransactionsApiClient interface {
	...
	GetTransactionSnapshots(ctx context.Context, in *TransactionSnapshotsRequest, opts ...grpc.CallOption) (TransactionsApi_GetTransactionSnapshotsClient, error)
...
func (c *transactionsApiClient) GetTransactions(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetTransactionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[0], TransactionsApi_GetTransactions_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetTransactionSnapshots(ctx context.Context, in *TransactionSnapshotsRequest, opts ...grpc.CallOption) (TransactionsApi_GetTransactionSnapshotsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[1], TransactionsApi_GetTransactionSnapshots_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &transactionsApiGetTransactionSnapshotsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type TransactionsApi_GetTransactionSnapshotsClient interface {
	Recv() (*TransactionSnapshotResponse, error)
	grpc.ClientStream
}

type transactionsApiGetTransactionSnapshotsClient struct {
	grpc.ClientStream
}

func (x *transactionsApiGetTransactionSnapshotsClient) Recv() (*TransactionSnapshotResponse, error) {
	m := new(TransactionSnapshotResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *transactionsApiClient) GetStateChanges(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetStateChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[2], TransactionsApi_GetStateChanges_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetStatuses(ctx context.Context, in *TransactionsByIdRequest, opts ...grpc.CallOption) (TransactionsApi_GetStatusesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[3], TransactionsApi_GetStatuses_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetUnconfirmed(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetUnconfirmedClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[4], TransactionsApi_GetUnconfirmed_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*waves.SignedTransaction, error) {
	...
	err := c.cc.Invoke(ctx, TransactionsApi_Sign_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionsApiClient) Broadcast(ctx context.Context, in *waves.SignedTransaction, opts ...grpc.CallOption) (*waves.SignedTransaction, error) {
	out := new(waves.SignedTransaction)
	err := c.cc.Invoke(ctx, TransactionsApi_Broadcast_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionsApiServer interface {
	...
	GetTransactionSnapshots(*TransactionSnapshotsRequest, TransactionsApi_GetTransactionSnapshotsServer) error
	// Deprecated: Do not use.
...
func (UnimplementedTransactionsApiServer) GetTransactionSnapshots(*TransactionSnapshotsRequest, TransactionsApi_GetTransactionSnapshotsServer) error {
...
func _TransactionsApi_GetTransactionSnapshots_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TransactionsApiServer).GetTransactionSnapshots(m, &transactionsApiGetTransactionSnapshotsServer{stream})
}

type TransactionsApi_GetTransactionSnapshotsServer interface {
	Send(*TransactionSnapshotResponse) error
	grpc.ServerStream
}

type transactionsApiGetTransactionSnapshotsServer struct {
	grpc.ServerStream
}

func (x *transactionsApiGetTransactionSnapshotsServer) Send(m *TransactionSnapshotResponse) error {
	return x.ServerStream.SendMsg(m)
}
