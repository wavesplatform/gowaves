...
func (c *transactionsApiClient) GetTransactionSnapshots(ctx context.Context, in *TransactionSnapshotsRequest, opts ...grpc.CallOption) (TransactionsApi_GetTransactionSnapshotsClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[1], "/waves.node.grpc.TransactionsApi/GetTransactionSnapshots", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetStateChanges(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetStateChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[2], "/waves.node.grpc.TransactionsApi/GetStateChanges", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetStatuses(ctx context.Context, in *TransactionsByIdRequest, opts ...grpc.CallOption) (TransactionsApi_GetStatusesClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[3], "/waves.node.grpc.TransactionsApi/GetStatuses", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transactionsApiClient) GetUnconfirmed(ctx context.Context, in *TransactionsRequest, opts ...grpc.CallOption) (TransactionsApi_GetUnconfirmedClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionsApi_ServiceDesc.Streams[4], "/waves.node.grpc.TransactionsApi/GetUnconfirmed", opts...)
	if err != nil {
		return nil, err
	}
