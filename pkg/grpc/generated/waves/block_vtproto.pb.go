...
func (m *Block_Header_ChallengedHeader) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.HeaderSignature) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.HeaderSignature)))
		i--
		dAtA[i] = 0x42
	}
	...
	if m.RewardVote != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.RewardVote))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Generator) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Generator)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Timestamp != 0 {
	...
	if len(m.GenerationSignature) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.GenerationSignature)))
		i--
		dAtA[i] = 0x12
	}
	if m.BaseTarget != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.BaseTarget))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Block_Header) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.FinalizationVoting != nil {
		size, err := m.FinalizationVoting.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.ChallengedHeader != nil {
		size, err := m.ChallengedHeader.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *MicroBlock) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.UpdatedBlockSignature) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.UpdatedBlockSignature)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Reference) > 0 {
...
func (m *SignedMicroBlock) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.TotalBlockId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TotalBlockId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Signature) > 0 {
...
func (m *EndorseBlock) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.FinalizedBlockId) > 0 {
		...
		copy(dAtA[i:], m.FinalizedBlockId)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FinalizedBlockId)))
		i--
		dAtA[i] = 0x12
	}
	if m.EndorserIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.EndorserIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *FinalizationVoting) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.ConflictEndorsements) > 0 {
		for iNdEx := len(m.ConflictEndorsements) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.ConflictEndorsements[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.AggregatedEndorsementSignature) > 0 {
		i -= len(m.AggregatedEndorsementSignature)
		copy(dAtA[i:], m.AggregatedEndorsementSignature)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AggregatedEndorsementSignature)))
		i--
		dAtA[i] = 0x1a
	}
	if m.FinalizedBlockHeight != 0 {
	...
	if len(m.EndorserIndexes) > 0 {
		var pksize2 int
		for _, num := range m.EndorserIndexes {
			pksize2 += protohelpers.SizeOfVarint(uint64(num))
		}
		i -= pksize2
		j1 := i
		for _, num1 := range m.EndorserIndexes {
			num := uint64(num1)
			for num >= 1<<7 {
				dAtA[j1] = uint8(uint64(num)&0x7f | 0x80)
				num >>= 7
...
func (m *Block_Header_ChallengedHeader) SizeVT() (n int) {
	...
	_ = l
	if m.BaseTarget != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.BaseTarget))
	}
...
func (m *Block_Header) SizeVT() (n int) {
	...
	if m.ChallengedHeader != nil {
		l = m.ChallengedHeader.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.FinalizationVoting != nil {
		l = m.FinalizationVoting.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *EndorseBlock) SizeVT() (n int) {
	...
	_ = l
	if m.EndorserIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.EndorserIndex))
	}
	l = len(m.FinalizedBlockId)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.FinalizedBlockHeight != 0 {
...
func (m *FinalizationVoting) SizeVT() (n int) {
	...
	if len(m.EndorserIndexes) > 0 {
		l = 0
		for _, e := range m.EndorserIndexes {
			l += protohelpers.SizeOfVarint(uint64(e))
		}
		n += 1 + protohelpers.SizeOfVarint(uint64(l)) + l
	}
	...
	if len(m.ConflictEndorsements) > 0 {
		for _, e := range m.ConflictEndorsements {
			l = e.SizeVT()
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *Block_Header_ChallengedHeader) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: Block_Header_ChallengedHeader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Block_Header_ChallengedHeader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Block_Header) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChallengedHeader", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ChallengedHeader == nil {
				m.ChallengedHeader = &Block_Header_ChallengedHeader{}
			}
			if err := m.ChallengedHeader.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinalizationVoting", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FinalizationVoting == nil {
				m.FinalizationVoting = &FinalizationVoting{}
			}
			if err := m.FinalizationVoting.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EndorseBlock) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EndorseBlock: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EndorseBlock: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndorserIndex", wireType)
			}
			m.EndorserIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EndorserIndex |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			m.FinalizedBlockId = append(m.FinalizedBlockId[:0], dAtA[iNdEx:postIndex]...)
			if m.FinalizedBlockId == nil {
				m.FinalizedBlockId = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
...
func (m *FinalizationVoting) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FinalizationVoting: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FinalizationVoting: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
				...
				m.EndorserIndexes = append(m.EndorserIndexes, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.EndorserIndexes) == 0 {
					m.EndorserIndexes = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field EndorserIndexes", wireType)
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinalizedBlockHeight", wireType)
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FinalizedBlockHeight |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AggregatedEndorsementSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AggregatedEndorsementSignature = append(m.AggregatedEndorsementSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.AggregatedEndorsementSignature == nil {
				m.AggregatedEndorsementSignature = []byte{}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConflictEndorsements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConflictEndorsements = append(m.ConflictEndorsements, &EndorseBlock{})
			if err := m.ConflictEndorsements[len(m.ConflictEndorsements)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
