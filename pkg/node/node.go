...
func (a *Node) Run(
	...
	networkMsgCh <-chan network.InfoMessage, syncPeer *network.SyncPeer, logger *slog.Logger,
) {
	...
	m, async, err := fsm.NewFSM(a.services, a.microblockInterval, a.obsolescence, syncPeer, a.enableLightMode, logger)
	if err != nil {
