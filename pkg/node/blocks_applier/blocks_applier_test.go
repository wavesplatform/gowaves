...
func TestApply_InvalidBlockWithRollback(t *testing.T) {
	...
	stateMock.EXPECT().AddDeserializedBlocks([]*proto.Block{block2}, false).Return(nil, errors.New("error message"))
	// return blocks
	stateMock.EXPECT().AddDeserializedBlocks([]*proto.Block{block1}, false).Return(nil, nil)
