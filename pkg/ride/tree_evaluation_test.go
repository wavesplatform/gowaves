...
func TestInvokeDAppFromDApp(t *testing.T) {
	...
	@Callable(i)
	func test() = {
	  let res = callDApp(Address(base58'3P5Bfd58PPfNvBM2Hy8QfbcDqMeNtzg7KfP'), "settle", [1,2], [AttachedPayment(base58'', 1234), AttachedPayment(base58'', 1234)])
	  res._1
	}
	...
	*/
	...
	firstScript := ""
