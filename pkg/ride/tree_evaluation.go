...
func invokeFunctionFromDApp(env RideEnvironment, recipient proto.Recipient, fnName rideType, listArgs rideType) (RideResult, error) {
	...
	args, ok := listArgs.(rideList)
	//var args []rideType
	//for _,arg := range rideList {
