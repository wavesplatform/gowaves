...
func TestLastIndexOfSubstringWithOffset(t *testing.T) {
	for _, test := range []struct {
		...
		//TODO:
		{[]rideType{rideString("世界x冬x世界x冬x"), rideString("冬x"), rideInt(14)}, false, rideInt(9)},
		{[]rideType{rideString("世界x冬x世界x冬x"), rideString("冬x"), rideInt(9)}, false, rideInt(3)},
		{[]rideType{takeRideString("x冬x冬x", 4), takeRideString("冬", 1), rideInt(4)}, false, rideInt(4)},
		{[]rideType{takeRideString("x冬x冬x", 4), takeRideString("冬", 1), rideInt(3)}, false, rideInt(1)},
		{[]rideType{takeRideString("x�x冬x", 4), takeRideString("冬", 1), rideInt(3)}, false, rideInt(3)},
		{[]rideType{takeRideString("x�x冬x", 4), takeRideString("冬", 1), rideInt(3)}, false, rideInt(3)},
