...
func (s *serializerV1) serialize(tree *Tree) ([]byte, error) {
	if tree.IsDApp() {
...
func (s *serializerV1) serializeDApp(tree *Tree) error {
...
func (s *serializerV1) serializeScript(tree *Tree) error {
	if err := s.writeByte(byte(tree.LibVersion)); err != nil {
		return err
	}
...
func (s *serializerV1) writeMeta(m meta.DApp) error {
...
func (s *serializerV1) writeDeclarations(declarations []Node) error {
...
func (s *serializerV1) writeDeclaration(declaration Node) error {
...
func (s *serializerV1) writeFunctions(functions []Node) error {
...
func (s *serializerV1) writeVerifier(verifier Node) error {
	if verifier != nil {
...
func (s *serializerV1) writeFunction(function *FunctionDeclarationNode) error {
...
func (s *serializerV1) writeAssignmentDeclaration(assignment *AssignmentNode) error {
...
func (s *serializerV1) writeFunctionDeclaration(function *FunctionDeclarationNode) error {
...
func (s *serializerV1) walk(node Node) error {
	switch n := node.(type) {
	case *LongNode:
...
func (s *serializerV1) writeByte(b byte) error {
	return s.buf.WriteByte(b)
}

func (s *serializerV1) writeUint16(v int) error {
...
func (s *serializerV1) writeUint32(v int) error {
...
func (s *serializerV1) writeBytes(data []byte) error {
	n := len(data)
...
func (s *serializerV1) writeString(str string) error {
