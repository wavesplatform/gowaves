...
import "github.com/wavesplatform/gowaves/pkg/scripting"

func selectFunctionsByName(v scripting.LibraryVersion, enableInvocation bool) (func(string) (rideFunction, bool), error) {
	switch v {
...
func selectFunctions(v scripting.LibraryVersion) (func(id int) rideFunction, error) {
	switch v {
	case scripting.LibV1, scripting.LibV2:
...
func selectFunctionChecker(v scripting.LibraryVersion) (func(name string) (uint16, bool), error) {
	switch v {
	case scripting.LibV1, scripting.LibV2:
...
func selectEvaluationCostsProvider(v scripting.LibraryVersion, ev int) (map[string]int, error) {
	switch v {
	case scripting.LibV1, scripting.LibV2:
		switch ev {
		case 1:
	...
	case scripting.LibV6: // Only new version of evaluator works after activation of RideV6
...
func selectFunctionNameProvider(v scripting.LibraryVersion) (func(int) string, error) {
	switch v {
	case scripting.LibV1, scripting.LibV2:
...
func selectConstants(v scripting.LibraryVersion) (func(int) rideConstructor, error) {
	switch v {
...
func selectConstantsChecker(v scripting.LibraryVersion) (func(name string) (uint16, bool), error) {
	switch v {
	case scripting.LibV1:
