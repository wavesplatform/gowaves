...
func (tx *IssueWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < issueWithSigFixedBodyLen {
		return errors.Errorf("%d bytes is not enough for IssueWithSig transaction, expected not less than %d bytes", l, issueWithSigFixedBodyLen)
	}
...
func (tx *IssueWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < issueWithSigMinLen {
		return errors.Errorf("%d is not enough data for IssueWithSig transaction, expected not less than %d", l, issueWithSigMinLen)
	}
...
func (tx *TransferWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < transferWithSigFixedBodyLen {
		return errors.Errorf("%d bytes is not enough for TransferWithSig transaction, expected not less than %d bytes", l, transferWithSigFixedBodyLen)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *TransferWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < transferWithSigMinLen {
		return errors.Errorf("not enough data for TransferWithSig transaction, expected not less than %d, received %d", transferWithSigMinLen, l)
	}
...
func (tx *ReissueWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < reissueWithSigBodyLen {
		return errors.Errorf("not enough data for ReissueWithSig transaction %d, expected not less than %d", l, reissueWithSigBodyLen)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *ReissueWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < reissueWithSigMinLen {
		return errors.Errorf("not enough data for ReissueWithSig transaction, expected not less than %d, received %d", reissueWithSigMinLen, l)
	}
...
func (tx *BurnWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < burnWithSigBodyLen {
		return errors.Errorf("%d bytes is not enough for BurnWithSig transaction, expected not less than %d", l, burnWithSigBodyLen)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *BurnWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < burnWithSigLen {
		return errors.Errorf("not enough data for BurnWithSig transaction, expected not less than %d, received %d", burnWithSigLen, l)
	}
...
func (tx *ExchangeWithSig) bodyUnmarshalBinary(data []byte) (int, error) {
	...
	if l := len(data); l < expectedLen {
		return 0, errors.Errorf("not enough data for ExchangeWithSig transaction, expected not less than %d, received %d", expectedLen, l)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *ExchangeWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < exchangeWithSigMinLen {
		return errors.Errorf("not enough data for ExchangeWithSig transaction, expected not less than %d, received %d", exchangeWithSigMinLen, l)
	}
...
func (tx *LeaseWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < leaseWithSigBodyLen {
		return errors.Errorf("not enough data for LeaseWithSig transaction, expected not less than %d, received %d", leaseWithSigBodyLen, l)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *LeaseWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < leaseWithSigMinLen {
		return errors.Errorf("not enough data for LeaseWithSig transaction, expected not less than %d, received %d", leaseWithSigMinLen, l)
	}
...
func (tx *LeaseCancelWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < leaseCancelWithSigBodyLen {
		return errors.Errorf("not enough data for LeaseCancelWithSig transaction, expected not less than %d, received %d", leaseCancelWithSigBodyLen, l)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *LeaseCancelWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < leaseCancelWithSigMinLen {
		return errors.Errorf("not enough data for LeaseCancelWithSig transaction, expected not less than %d, received %d", leaseCancelWithSigMinLen, l)
	}
...
func (tx *CreateAliasWithSig) bodyUnmarshalBinary(data []byte) error {
	if l := len(data); l < createAliasWithSigFixedBodyLen {
		return errors.Errorf("not enough data for CreateAliasWithSig transaction, expected not less than %d, received %d", createAliasWithSigFixedBodyLen, l)
	}
	tx.Type = TransactionType(data[0])
...
func (tx *CreateAliasWithSig) UnmarshalBinary(data []byte, scheme Scheme) error {
	if l := len(data); l < createAliasWithSigMinLen {
		return errors.Errorf("not enough data for CreateAliasWithSig transaction, expected not less than %d, received %d", createAliasWithSigMinLen, l)
	}
