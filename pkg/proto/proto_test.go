...
var tests = []protocolMarshallingTest{
	//{
	//	&Handshake{"ab", Version{0x10, 0x3, 0x8}, "dc", 0x701, HandshakeTCPAddr{}, 0x8000},
	//	"0261620000001000000003000000080264630000000000000701000000000000000000000a8000",
	//},
	//{
	...
	for _, v := range tests {
		t.Run(fmt.Sprintf("%T", v.testMessage), func(t *testing.T) {
			...
			/*
				...
				0x0, 0x0, 0x0, 0x4, ???   0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x0
			*/
