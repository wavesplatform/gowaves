...
// EmptyHandshake provides a mock function with given fields:
...
// EmptyHeader provides a mock function with given fields:
...
func (_m *MockProtocol) IsAcceptableHandshake(_a0 networking.Handshake) bool {
	ret := _m.Called(_a0)
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(networking.Handshake) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
//   - _a0 networking.Handshake
func (_e *MockProtocol_Expecter) IsAcceptableHandshake(_a0 interface{}) *MockProtocol_IsAcceptableHandshake_Call {
	return &MockProtocol_IsAcceptableHandshake_Call{Call: _e.mock.On("IsAcceptableHandshake", _a0)}
}

func (_c *MockProtocol_IsAcceptableHandshake_Call) Run(run func(_a0 networking.Handshake)) *MockProtocol_IsAcceptableHandshake_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(networking.Handshake))
	})
	return _c
}
...
func (_c *MockProtocol_IsAcceptableHandshake_Call) RunAndReturn(run func(networking.Handshake) bool) *MockProtocol_IsAcceptableHandshake_Call {
	_c.Call.Return(run)
	return _c
}

// IsAcceptableMessage provides a mock function with given fields: _a0
func (_m *MockProtocol) IsAcceptableMessage(_a0 networking.Header) bool {
	ret := _m.Called(_a0)
...
func (_e *MockProtocol_Expecter) IsAcceptableMessage(_a0 interface{}) *MockProtocol_IsAcceptableMessage_Call {
	return &MockProtocol_IsAcceptableMessage_Call{Call: _e.mock.On("IsAcceptableMessage", _a0)}
}

func (_c *MockProtocol_IsAcceptableMessage_Call) Run(run func(_a0 networking.Header)) *MockProtocol_IsAcceptableMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockProtocol_IsAcceptableMessage_Call) RunAndReturn(run func(networking.Header) bool) *MockProtocol_IsAcceptableMessage_Call {
	_c.Call.Return(run)
	return _c
}
