...
func (_m *MockHandler) OnHandshakeFailed(_a0 *networking.Session, _a1 networking.Handshake) {
	_m.Called(_a0, _a1)
}
...
//   - _a0 *networking.Session
//   - _a1 networking.Handshake
func (_e *MockHandler_Expecter) OnHandshakeFailed(_a0 interface{}, _a1 interface{}) *MockHandler_OnHandshakeFailed_Call {
	return &MockHandler_OnHandshakeFailed_Call{Call: _e.mock.On("OnHandshakeFailed", _a0, _a1)}
}

func (_c *MockHandler_OnHandshakeFailed_Call) Run(run func(_a0 *networking.Session, _a1 networking.Handshake)) *MockHandler_OnHandshakeFailed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*networking.Session), args[1].(networking.Handshake))
	})
	return _c
...
func (_c *MockHandler_OnHandshakeFailed_Call) RunAndReturn(run func(*networking.Session, networking.Handshake)) *MockHandler_OnHandshakeFailed_Call {
	_c.Run(run)
	return _c
}
