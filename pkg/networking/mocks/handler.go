...
func (_m *MockHandler) OnReceive(_a0 *networking.Session, _a1 []byte) {
	_m.Called(_a0, _a1)
}
...
func (_c *MockHandler_OnReceive_Call) Run(run func(_a0 *networking.Session, _a1 []byte)) *MockHandler_OnReceive_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*networking.Session), args[1].([]byte))
	})
	return _c
}
...
func (_c *MockHandler_OnReceive_Call) RunAndReturn(run func(*networking.Session, []byte)) *MockHandler_OnReceive_Call {
	_c.Call.Return(run)
	return _c
}
