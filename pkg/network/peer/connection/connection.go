...
//}
//
//// message than sended when connected
...
//
//			connected := &Connected{
//				Version: connVersion.version,
//			}
//
//			select {
//			case a.infoCh <- connected:
//			default:
//			}
//
//			go func() {
...
//			fmt.Println("Connection got bts, conntected", a.connected, " id ", a.conn.RemoteAddr().String())
//			if a.connected {
//				_, err := a.conn.Write(bts)
//				if err != nil {
//					fmt.Printf("error writing to %s err %s\n", a.conn.RemoteAddr().String(), err)
//					select {
//					case a.infoCh <- err:
//					default:
//					}
